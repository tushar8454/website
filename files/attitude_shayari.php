...
<meta name="keywords" content="khatarnak attitude shayari, attitude shayari love, attitude shayari 2 line, hacker attitude shayari in hindi, attitude shayari emoji, attitude shayari girls, boy attitude shayari"/>

<link rel="canonical" href="https://www.shayariindustry.com/attitude_shayari.php/" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://www.shayariindustry.com/attitude_shayari.php/" />
...
WHERE category = 'attitude shayari'";
...
if (mysqli_num_rows($result)) {
    ...
    header("location:attitude_shayari.php");
}
...
?>  
           ...
           if ($page_no >= 2) {
               echo '<a href="https://shayariindustry.com/attitude_shayari.php?page=' .
                   ($page_no - 1) .
                   '" class="prev">Prev</a>';
           }
           ...
           for ($i = $start; $i <= $end; $i++) {
               ...
               echo '
       <a href="https://shayariindustry.com/attitude_shayari.php?page=' .
                   $i .
                   '"<li class=" ' .
                   $current .
                   ' ">' .
