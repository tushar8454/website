...
echo '<a href="https://shayariindustry.com/inspirational_shayari.php?page='.($page_no-1).'" class="prev">Prev</a>';
...
echo'
<a href="https://shayariindustry.com/inspirational_shayari.php?page='.$i.'"<li class=" '.$current.' ">'.$i.'</li></a>
...
echo '<a href="https://shayariindustry.com/inspirational_shayari.php?page='.($page_no+1).'" class="next">Next</a>';
