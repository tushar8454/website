...
$end=($page_no + 4);
  ...
  if($page_no>=2){
    ...
    echo '<a href="ilzam_shayari.php?page='.($page_no-1).'" class="prev">Prev</a>';
  ...
  for($i=$start;$i<=$end;$i++){
      if($i==$page_no){
       ...
       echo'
       <a href="ilzam_shayari.php?page='.$i.'"<li class=" '.$current.' ">'.$i.'</li></a>
       ...
       if($page_no < $pages){
        ...
        echo '<a href="ilzam_shayari.php?page='.($page_no+1).'" class="next">Next</a>';
