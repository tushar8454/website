...
<title>Friendship Shayari ! Best friend Shayari Hindi ! फ्रेंडशिप शायरी ! ...</title>
...
<meta name="keywords" content="friendship shayari for girlfriend in hindi, friendship shayari in english, funny friendship shayari in hindi, zindagi aur dosti shayari, online friendship shayari, shayari for best friend girl in hindi, friendship shayari 2 line
"/>
...
$end=($page_no + 4);
  ...
  if($page_no>=2){
    ...
    echo '<a href="friendship_shayari.php?page='.($page_no-1).'" class="prev">Prev</a>';
  ...
  for($i=$start;$i<=$end;$i++){
      if($i==$page_no){
       ...
       echo'
       <a href="friendship_shayari.php?page='.$i.'"<li class=" '.$current.' ">'.$i.'</li></a>
       ...
       if($page_no < $pages){
        ...
        echo '<a href="friendship_shayari.php?page='.($page_no+1).'" class="next">Next</a>';
